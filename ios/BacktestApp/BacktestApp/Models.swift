...
struct Trade: Decodable, Identifiable {
    ...
    // Computed dollar P&L based on a notional $10k per trade
...
let availableStrategies: [Strategy] = [
    ...
    Strategy(id: "moving_average", name: "Moving Average Crossover",description: "20/50-day MA cross — buy on golden cross, sell on death cross."),
    Strategy(id: "breakout",       name: "Breakout",                description: "20-day channel high/low"),
    Strategy(id: "ensemble",       name: "Ensemble",                description: "Majority vote across all 5 strategies"),
]
